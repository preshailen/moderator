...
export const ROUTES: RouteInfo[] = [
    ...
    { path: '/moderator-list', title: 'Moderate', icon: 'nc-ruler-pencil', class: '', role: 'Moderator' },
		{ path: '/comments', title: 'Comments', icon: 'nc-chat-33', class: '', role: 'Moderator' },
		{ path: '/permissions-error', title: 'Permissions Error', icon: 'nc-simple-remove', class: '', role: 'Error' },
