...
export class AppSession {
  ...
  constructor(private authSession: GapiSession, private breadCrumbSession: BreadCrumbSession, private fileSession: FileSession, private userSession: UserSession) {}
